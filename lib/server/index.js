...
import { collectScenarios, launchRun, LaunchError, rebuildReport, resolveArmPath } from '../core/orchestrate.js';
import { describeDiff, evalProfileManifest, prepareArms } from '../core/plan.js';
import { loadProject } from '../core/project.js';
import { selfcheckAll } from '../core/selfcheck.js';
import { listRuns, readEnvironment, readJson, readLedgers, readPlan, runPaths } from '../core/store.js';
...
export class EvalApp {
    ...
    async api(req, res, path, url) {
        ...
        if (method === 'GET' && path === '/runs') {
            json(res, 200, listRuns(project.runsRoot));
            return;
        }
