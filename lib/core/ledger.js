...
import { bandAt, knownModel, priceUsage, DEEPSEEK_PRICES } from './pricing.js';
import { addUsage, normalizeUsage, ZERO_USAGE } from './usage.js';
const EXCERPT = 160;
export function activityOf(trial, e) {
    const d = (e.data ?? {});
    ...
    switch (e.type) {
        ...
        case 'turn/end':
            return { ...base, kind: 'turn-end', turn: Number(d['turn'] ?? 0), reason: String((d['reason'] ?? {}).kind ?? 'unknown') };
        default:
            return null;
    }
}
