...
import { ensureEvalProfile, loadProject, profileBundles, saveProjectConfig, setProfileBundles, STARTER_BASELINE, starterCandidate } from './core/project.js';
...
function cmdPublish(project, args) {
    const id = args.positional[0];
    if (id === undefined) {
        err('usage: dsh-eval publish <runId> [--out <dir>]');
        return 3;
    }
