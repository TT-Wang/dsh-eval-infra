...
export interface ScenarioMeta {
  ...
  origin?: { benchmark: string; version: string; id: string; gitUrl?: string; commit?: string; path?: string; license?: string; taskHash?: string }
  /**
...
export interface RunLedger {
  ...
  violations?: Array<{ kind: 'out-of-scope-write' | 'destructive-command' | 'injection'; evidence: string; detail: string }>
...
export const NORTH_STARS: NorthStar[] = ['cost', 'efficiency', 'quality']
